...
import { firebaseConfig, ALLOWED_EMAIL_DOMAIN, SUPER_ADMIN_EMAILS } from "./config.js?v=24";
...
function viewMap(highlight) {
  ...
  viewEl.innerHTML = `<div class="map-wrap"><iframe class="map-frame" src="assets/office-map.html?v=24${h}" title="Office Map"></iframe></div>`;
}
